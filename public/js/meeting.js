...
function StartMeeting(roomName,dispNme){
    ...
    const options = {
        ...
        interfaceConfigOverwrite: {
            ...
            DEFAULT_REMOTE_DISPLAY_NAME: 'New User',
            //TOOLBAR_BUTTONS: ['microphone', 'camera', 'closedcaptions', 'desktop', 'fullscreen', 'fodeviceselection', 'hangup', 'profile', 'chat', 'recording', 'livestreaming', 'etherpad', 'sharedvideo', 'settings', 'raisehand', 'filmstrip', 'invite', 'feedback', 'stats', 'shortcuts', 'tileview', 'videobackgroundblur', 'download', 'help', 'mute-everyone', 'security']
        },
        onload: function () {
            //alert('loaded');
            $('#joinMsg').hide();
